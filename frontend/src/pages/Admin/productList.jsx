      ...
      <div className="flex flex-col md:flex-row">
        <div className="md:w-3/4 p-3">
          ...
          <div className="p-3 ml-[70px]">
            ...
            <label htmlFor="" className="my-5 h-[40vh]">
              Description
            </label>
            <textarea
              type="text"
            ...
            <div className="flex justify-between">
              <div>
                <label htmlFor="stock block">In Stock</label> <br />
                <input
                  type="text"
                  className="p-4 mb-3 w-[30rem] border rounded-lg bg-[#ffffff] text-black"
                  value={stock}
            ...
            <button
              ...
              className="py-4 px-10 mt-5 rounded-lg text-lg font-bold bg-black text-white"
            >
              Submit
            </button>
          </div>
